            ...
            active = ndx;
             if (ndx == 'inicio') {
                $('.opcion').removeClass("seleccionado");
                 $('.opcion').removeClass("deseleccionado");
            }else {
                $('.opcion').addClass("deseleccionado");
                 $('[data-scroll-nav=' + ndx + ']').parent().removeClass("deseleccionado");
                $('[data-scroll-nav=' + ndx + ']').parent().addClass("seleccionado");
            };
