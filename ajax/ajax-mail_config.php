...
/*--------------------- datos del correo -------------------------------------*/
define('mail', 'danielalmeida.mx@gmail.com'); //  mail de la prestadora de servicios 
...
if (isset($_POST[$id_form])) {
    ...
    if (defined('id_form')) { // detiene el código en caso de que ingrese información de dos o mas form diferentes
        ...
        define('primera_linea', 'Contacto Daniel Almeida'); // cambiar el primera linea del contenido del correo
